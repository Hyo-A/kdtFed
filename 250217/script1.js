...
// indexOf("morning") indexOf 뒤에 index 시작점의 값을 찾고자하는 인자값을 입력
console.log(str.indexOf("evening"));
// 만약 indexOf 뒤에 존재하지 않는 문자를 찾아오라고 한다면 default값이 -1

let firstIndex = str.indexOf("morning");

console.log(str.indexOf("morning", firstIndex + 1));
// morning을 찾아오는 변수를 만들어서, // indexOf("morning", firstIndex + 1) 로 기입한다면? 두번째 morning을 찾아옴
*/

const str1 = "Hello, everyone~";

// console.log(str1.includes("ne~"));
// str1 전체 문자열에 ne~가 있나?
...
// startsWith("l", 2)에서 "l"이 index2에서 시작하는것이 맞는지 boolean값으로 알려줌
console.log(str1.endsWith("one", 15));
// endsWith("one", 15)에서 "one"이 index15에서 끝나는것이 맞는지 boolean값으로 알려줌
console.log(str1.endsWith("lo", 5));

// console.log(str1.endsWith("everyone~"));
// console.log(str1.endsWith("Everyone~"));
// console.log(str1.endsWith("one~"));
// console.log(str1.endsWith("o, everyone"));

console.log(str1.startsWith("Hello"));
console.log(str1.startsWith("He"));
console.log(str1.startsWith("he"));
console.log(str1.startsWith("Hello, eve"));
// startsWith 는 ~과함께 시작하는건지?
